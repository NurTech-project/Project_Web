            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 text-center">
                    ...
                    <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
                        ...
                        <h1 class="block w-full text-center text-gray-800 text-2xl font-bold mb-6">crear nueva historia</h1>
                        <form action="{{url('/historia/create')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input class="border py-2 px-3 text-grey-800" type="file" name="imagen" id="imagen">
                            </div>
                            <div class="flex flex-col mb-4">
