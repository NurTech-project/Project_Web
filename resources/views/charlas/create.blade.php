            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 text-center">
                    ...
                    <div class="px-20 w-full bg-white rounded shadow-2xl p-8 m-4">
                        ...
                        <h1 class="block w-full text-center text-gray-800 text-3xl font-bold ">Crear Nueva Charla</h1>
                        <br>
                        <form action="{{url('/charla/create')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <br><hr>
                            <div class="flex flex-col mb-4">
                                <label class="text-left mb-2 font-bold text-lg text-gray-900" for="imagen" >Link del Video:</label>
                                <input class="border py-2 px-3 text-grey-800" type="text" name="link_video" id="link_video"  placeholder="Escribe el link ...">
                            </div>
                            <br><br><hr>
                            <div class="flex flex-col mb-4">
                                <label class="text-left mb-2 font-bold text-lg text-gray-900" for="descripcion">Descripcion:</label>
                                <textarea cols="70" rows="10" name="descripcion" id="descripcion" ></textarea>
                            </div>
                            <br><br><hr>
                            <div class="flex flex-col mb-4">
                                <label class="text-left mb-2 font-bold text-lg text-gray-900" for="estado">Estado:</label>
