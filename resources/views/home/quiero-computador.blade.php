...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="bg-gray-800">
        <br>
         <h1 class="text-center text-base text-2xl text-gray-400 font-serif">
            CONTACTOS
         </h1>
         <br>
         <div class="border-b-2 ml-96 mr-96">

         </div>
         <br>
         <h1 class="text-center text-base text-gray-400 font-serif">
            Direccion: Av.García Moreno S4-35 y, Quito 170401
         </h1>
         <br>
         <h1 class="text-center text-base text-gray-400 font-serif">
            Telefonos: (593) 999 705 620
         </h1>
         <br>
         <h1 class="text-center text-base text-gray-400 font-serif">
         ...
         <br>
         <div class="ml-12">
         <img src="../imagenes/icons2.jpg" alt="" width="500" class="ml-96">
         </div>
    </div>
</body>
</html>
