<x-app-layout>
    <x-slot name="header">
        <h2 class="px-4 font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Entrega de equipo diagnosticado') }}
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <h2 class="mb-4 text-4xl font-black text-center ">Entrega de equipo diagnosticado</h2>
                    <p>Nota: Tenga en cuenta que al momento de rechazar la entrega, el proceso para retirar el equipo diagnosticado sería aún más largo</p>
                    ...
                    <hr><br>
                        ...
                        <a href="{{ route('tecnico_entrega_edit', $equipo->entregaId ) }}">Aceptar</a>
                        </x-button>
                        </td>
                        <td>
                        <form action="{{ route('tecnico_entrega_destroy', $equipo->entregaId ) }}" method="POST">
                        @csrf
                        @method('DELETE')
